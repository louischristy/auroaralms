...
@section('content')
    ...
    <div x-data="{
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5" @submit="handleSubmit($event)">
            ...
            <div x-show="ssoProviders.length > 0 && !forceSso" x-cloak class="relative">
                <div class="absolute inset-0 flex items-center"><div class="w-full border-t border-gray-200"></div></div>
            ...
            <div x-show="!forceSso" class="flex items-center justify-between">
            ...
            {{-- Force SSO message --}}
            <div x-show="forceSso" x-cloak class="text-center text-sm text-gray-500 mt-2">
