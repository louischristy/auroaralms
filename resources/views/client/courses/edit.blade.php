...
<div class="max-w-5xl mx-auto space-y-6" x-data="{ tab: '{{ session('_tab', 'details') }}' }">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('manage.courses.assign-users', $course) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium text-emerald-700 bg-emerald-50 hover:bg-emerald-100 transition">
    ...
    <div class="border-b border-gray-200">
        <nav class="flex gap-6">
            @foreach(['details' => 'Details', 'lessons' => 'Lessons', 'quiz' => 'Quiz'] as $key => $label)
    ...
    <div x-show="tab === 'details'" x-cloak>
        <div class="card p-6">
            <form method="POST" action="{{ route('manage.courses.update', $course) }}" class="space-y-5">
                @csrf @method('PUT')
                ...
                <div class="flex justify-between pt-4 border-t">
                    <form method="POST" action="{{ route('manage.courses.destroy', $course) }}" onsubmit="return confirm('Delete this course? This cannot be undone.')">
                        @csrf @method('DELETE')
                        ...
                        <div class="px-6 py-4" x-data="{ editing: false }" data-lesson-id="{{ $lesson->id }}">
                            <div x-show="!editing" class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <form method="POST" action="{{ route('manage.courses.lessons.destroy', [$course, $lesson]) }}"
    ...
    <div x-show="tab === 'quiz'" x-cloak>
        ...
        <div class="card p-6 mb-6">
            ...
            <form method="POST" action="{{ route('manage.courses.quiz.store', $course) }}" class="space-y-4">
                @csrf
