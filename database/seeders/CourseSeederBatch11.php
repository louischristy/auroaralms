                ...
                'quiz' => [
                    ...
                    'questions' => [
                        [
                            ...
                            'answers' => [
                                ['answer_text' => 'They exploit the trust placed in legitimate vendors and software providers', 'is_correct' => true],
                                ['answer_text' => 'They only target small businesses', 'is_correct' => false],
                                ['answer_text' => 'They require physical access to the target network', 'is_correct' => false],
                                ['answer_text' => 'They are easily detected by standard antivirus software', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'Which of the following is an example of an open-source supply chain attack?',
                            'answers' => [
                                ['answer_text' => 'Sending phishing emails to employees', 'is_correct' => false],
                                ['answer_text' => 'Poisoning a widely-used open-source library that many applications depend on', 'is_correct' => true],
                                ['answer_text' => 'Brute-forcing administrator passwords', 'is_correct' => false],
                                ['answer_text' => 'Physically tampering with a company server', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What is a Software Bill of Materials (SBOM) used for?',
                            'answers' => [
                                ['answer_text' => 'Tracking employee training completion', 'is_correct' => false],
                                ['answer_text' => 'Managing hardware inventory in the data center', 'is_correct' => false],
                                ['answer_text' => 'Maintaining a detailed inventory of all software components and dependencies for integrity verification', 'is_correct' => true],
                                ['answer_text' => 'Generating invoices for software licenses', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What is the recommended approach for deploying vendor software updates?',
                            'answers' => [
                                ['answer_text' => 'Install updates immediately upon release to patch vulnerabilities as fast as possible', 'is_correct' => false],
                                ['answer_text' => 'Delay updates for at least one year to allow others to find issues', 'is_correct' => false],
                                ['answer_text' => 'Test updates in an isolated staging environment and monitor for anomalies before production deployment', 'is_correct' => true],
                                ['answer_text' => 'Only install updates if the vendor sends a follow-up reminder', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'Which vendor risk management practice is most effective for ongoing supply chain security?',
                            'answers' => [
                                ['answer_text' => 'Conducting a single security assessment at the start of the vendor relationship', 'is_correct' => false],
                                ['answer_text' => 'Trusting vendor self-reported security questionnaires without verification', 'is_correct' => false],
                                ['answer_text' => 'Granting vendors full network access to simplify support workflows', 'is_correct' => false],
                                ['answer_text' => 'Regular security assessments, contractual breach notification obligations, and least-privilege access controls', 'is_correct' => true],
                            ],
                        ],
                    ],
                ],
                ...
                'quiz' => [
                    ...
                    'questions' => [
                        [
                            ...
                            'answers' => [
                                ['answer_text' => 'Moving security responsibilities to a separate team', 'is_correct' => false],
                                ['answer_text' => 'Addressing security concerns as early as possible in the development lifecycle', 'is_correct' => true],
                                ['answer_text' => 'Deploying software updates more frequently', 'is_correct' => false],
                                ['answer_text' => 'Reducing the number of developers on the team', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What is the most effective defense against SQL injection attacks?',
                            'answers' => [
                                ['answer_text' => 'Using a web application firewall as the sole defense', 'is_correct' => false],
                                ['answer_text' => 'Filtering out common SQL keywords from user input', 'is_correct' => false],
                                ['answer_text' => 'Using parameterized queries and prepared statements', 'is_correct' => true],
                                ['answer_text' => 'Limiting the length of user input fields', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What is the primary purpose of Static Application Security Testing (SAST)?',
                            'answers' => [
                                ['answer_text' => 'Testing the running application by simulating external attacks', 'is_correct' => false],
                                ['answer_text' => 'Analyzing source code to identify potential vulnerabilities without executing the application', 'is_correct' => true],
                                ['answer_text' => 'Scanning third-party libraries for known CVEs', 'is_correct' => false],
                                ['answer_text' => 'Performing manual penetration testing', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'When validating user input, which approach is more secure?',
                            'answers' => [
                                ['answer_text' => 'Client-side validation only, for faster user feedback', 'is_correct' => false],
                                ['answer_text' => 'Blocklists that reject known malicious patterns', 'is_correct' => false],
                                ['answer_text' => 'Server-side validation using allowlists that accept only expected patterns', 'is_correct' => true],
                                ['answer_text' => 'No validation, since the database will reject invalid data', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'Why is Software Composition Analysis (SCA) important for modern applications?',
                            'answers' => [
                                ['answer_text' => 'It replaces the need for code reviews', 'is_correct' => false],
                                ['answer_text' => 'Modern applications rely heavily on third-party and open-source components that may contain known vulnerabilities', 'is_correct' => true],
                                ['answer_text' => 'It guarantees that the application is free of all security flaws', 'is_correct' => false],
                                ['answer_text' => 'It is only required for applications written in JavaScript', 'is_correct' => false],
                            ],
                        ],
                    ],
                ],
                ...
                'quiz' => [
                    ...
                    'questions' => [
                        [
                            ...
                            'answers' => [
                                ['answer_text' => 'When a CEO commits financial fraud within their own company', 'is_correct' => false],
                                ['answer_text' => 'An attacker impersonating a senior executive to trick employees into transferring money or sharing data', 'is_correct' => true],
                                ['answer_text' => 'A compliance violation by a company executive', 'is_correct' => false],
                                ['answer_text' => 'An insider threat where the CEO\'s credentials are compromised', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'When verifying a suspicious email request, what is the safest approach?',
                            'answers' => [
                                ['answer_text' => 'Reply to the email asking for confirmation', 'is_correct' => false],
                                ['answer_text' => 'Call the phone number provided in the suspicious email', 'is_correct' => false],
                                ['answer_text' => 'Contact the requestor using a known phone number from the company directory or your own contacts', 'is_correct' => true],
                                ['answer_text' => 'Forward the email to a colleague for their opinion', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'Which financial control is most effective at preventing unauthorized wire transfers?',
                            'answers' => [
                                ['answer_text' => 'Allowing any manager to independently approve transfers of any amount', 'is_correct' => false],
                                ['answer_text' => 'Requiring dual authorization with two independent approvals for transfers above a threshold', 'is_correct' => true],
                                ['answer_text' => 'Processing all transfer requests within one hour to maintain efficiency', 'is_correct' => false],
                                ['answer_text' => 'Using email confirmation as the sole approval method', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What do DMARC, DKIM, and SPF protect against?',
                            'answers' => [
                                ['answer_text' => 'Malware infections on employee workstations', 'is_correct' => false],
                                ['answer_text' => 'Physical theft of company documents', 'is_correct' => false],
                                ['answer_text' => 'Email domain spoofing by verifying that emails genuinely come from the claimed sender domain', 'is_correct' => true],
                                ['answer_text' => 'Brute-force attacks against email passwords', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'If a BEC attack succeeds and funds are transferred, what should be the first response action?',
                            'answers' => [
                                ['answer_text' => 'Wait until the next business day to investigate', 'is_correct' => false],
                                ['answer_text' => 'Immediately contact the financial institution to attempt to recall the transfer', 'is_correct' => true],
                                ['answer_text' => 'Delete all evidence to prevent further exposure', 'is_correct' => false],
                                ['answer_text' => 'Send a company-wide email about the incident', 'is_correct' => false],
                            ],
                        ],
                    ],
                ],
                ...
                'quiz' => [
                    ...
                    'questions' => [
                        [
                            ...
                            'answers' => [
                                ['answer_text' => 'They are always connected to high-speed internet', 'is_correct' => false],
                                ['answer_text' => 'They often have default credentials, limited processing power for security software, and infrequent firmware updates', 'is_correct' => true],
                                ['answer_text' => 'They are only used in industrial environments', 'is_correct' => false],
                                ['answer_text' => 'They use the same operating system as desktop computers', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What is the most important first step when setting up a new IoT device?',
                            'answers' => [
                                ['answer_text' => 'Connect it to your primary Wi-Fi network', 'is_correct' => false],
                                ['answer_text' => 'Enable all available features for full functionality', 'is_correct' => false],
                                ['answer_text' => 'Change the default username and password immediately', 'is_correct' => true],
                                ['answer_text' => 'Register it with the manufacturer for warranty purposes', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What is the recommended network strategy for IoT devices?',
                            'answers' => [
                                ['answer_text' => 'Connect them to the same network as all other devices for simplicity', 'is_correct' => false],
                                ['answer_text' => 'Place them on a separate network segment isolated from computers and sensitive data', 'is_correct' => true],
                                ['answer_text' => 'Disconnect them from the network when not actively in use', 'is_correct' => false],
                                ['answer_text' => 'Use only wired connections for all IoT devices', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What should you do when an IoT device is no longer receiving firmware updates from its manufacturer?',
                            'answers' => [
                                ['answer_text' => 'Continue using it since it still works properly', 'is_correct' => false],
                                ['answer_text' => 'Install third-party security software on the device', 'is_correct' => false],
                                ['answer_text' => 'Plan to replace it or place it in strict network isolation', 'is_correct' => true],
                                ['answer_text' => 'Share the device password with IT so they can monitor it', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'When responding to a suspected IoT device compromise, what is the first action to take?',
                            'answers' => [
                                ['answer_text' => 'Update the device firmware to the latest version', 'is_correct' => false],
                                ['answer_text' => 'Immediately disconnect the device from the network', 'is_correct' => true],
                                ['answer_text' => 'Run an antivirus scan on the device', 'is_correct' => false],
                                ['answer_text' => 'Contact the device manufacturer for support', 'is_correct' => false],
                            ],
                        ],
                    ],
                ],
                ...
                'quiz' => [
                    ...
                    'questions' => [
                        [
                            ...
                            'answers' => [
                                ['answer_text' => 'Several hours of high-quality recordings', 'is_correct' => false],
                                ['answer_text' => 'Just a few minutes of recorded speech', 'is_correct' => true],
                                ['answer_text' => 'An entire day of continuous conversation', 'is_correct' => false],
                                ['answer_text' => 'Voice cloning requires direct access to the person', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'Which visual artifact is most commonly associated with deepfake video?',
                            'answers' => [
                                ['answer_text' => 'The video always appears in black and white', 'is_correct' => false],
                                ['answer_text' => 'The background is always blurred', 'is_correct' => false],
                                ['answer_text' => 'Unnatural blinking, facial boundary artifacts, or lip sync issues', 'is_correct' => true],
                                ['answer_text' => 'The person in the video always wears sunglasses', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What is the most reliable defense against a deepfake voice call requesting a financial transfer?',
                            'answers' => [
                                ['answer_text' => 'Listening carefully to determine if the voice sounds natural', 'is_correct' => false],
                                ['answer_text' => 'Asking the caller personal questions to verify their identity', 'is_correct' => false],
                                ['answer_text' => 'Verifying the request through an independent channel using a known contact number', 'is_correct' => true],
                                ['answer_text' => 'Recording the call for later analysis', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What is the purpose of pre-arranged code words or challenge phrases?',
                            'answers' => [
                                ['answer_text' => 'To encrypt email communications', 'is_correct' => false],
                                ['answer_text' => 'To verify identity during calls or meetings when deepfakes may be used', 'is_correct' => true],
                                ['answer_text' => 'To replace passwords for system access', 'is_correct' => false],
                                ['answer_text' => 'To report security incidents to management', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'Why is the democratization of AI deepfake tools a concern for organizations?',
                            'answers' => [
                                ['answer_text' => 'It makes AI tools more expensive for businesses to use', 'is_correct' => false],
                                ['answer_text' => 'It means only large companies are at risk', 'is_correct' => false],
                                ['answer_text' => 'Sophisticated attacks no longer require specialized skills or resources, increasing the number of potential attackers', 'is_correct' => true],
                                ['answer_text' => 'It reduces the quality of deepfake content', 'is_correct' => false],
                            ],
                        ],
                    ],
                ],
                ...
                'quiz' => [
                    ...
                    'questions' => [
                        [
                            ...
                            'answers' => [
                                ['answer_text' => 'HIPAA', 'is_correct' => false],
                                ['answer_text' => 'PCI DSS', 'is_correct' => false],
                                ['answer_text' => 'GDPR', 'is_correct' => true],
                                ['answer_text' => 'SOX', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'Under GDPR, how quickly must an organization notify the supervisory authority of a qualifying data breach?',
                            'answers' => [
                                ['answer_text' => 'Within 24 hours', 'is_correct' => false],
                                ['answer_text' => 'Within 72 hours', 'is_correct' => true],
                                ['answer_text' => 'Within 30 days', 'is_correct' => false],
                                ['answer_text' => 'Within 60 days', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'What does the principle of "data minimization" require?',
                            'answers' => [
                                ['answer_text' => 'Encrypting all data at rest', 'is_correct' => false],
                                ['answer_text' => 'Collecting and retaining only the personal data genuinely necessary for the stated purpose', 'is_correct' => true],
                                ['answer_text' => 'Storing data in the smallest possible file format', 'is_correct' => false],
                                ['answer_text' => 'Limiting the number of employees who can view reports', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'If you receive a data subject access request from a customer, what should you do?',
                            'answers' => [
                                ['answer_text' => 'Ignore it since only the legal team can respond', 'is_correct' => false],
                                ['answer_text' => 'Fulfill the request immediately by sending all available data', 'is_correct' => false],
                                ['answer_text' => 'Forward it immediately to your organization\'s designated privacy officer or data protection team', 'is_correct' => true],
                                ['answer_text' => 'Ask the customer to submit the request through a social media channel', 'is_correct' => false],
                            ],
                        ],
                        [
                            'question' => 'If you suspect a data breach has occurred, what is the correct first action?',
                            'answers' => [
                                ['answer_text' => 'Try to fix the problem yourself before reporting it', 'is_correct' => false],
                                ['answer_text' => 'Delete any affected logs to limit exposure', 'is_correct' => false],
                                ['answer_text' => 'Wait to see if anyone else notices before raising an alarm', 'is_correct' => false],
                                ['answer_text' => 'Report it immediately to your IT security team through the designated incident reporting channel', 'is_correct' => true],
                            ],
                        ],
                    ],
                ],
